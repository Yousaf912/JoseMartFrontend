                    ...
                    <div className="col-12 d-md-flex mt-4 align-items-center">
                        ...
                        <div className={`${style.textsection} col-md-6 px-5  p-3 rounded-4 text-white`}>
                            ...
                            {location == 'signup' &&
                                <div className='mb-2'>
                                    <div className='d-flex flex-column mt-3'>
                                        ...
                                        {erors.name && <h6 className='text-black'>{erors.name.message}</h6>}
                                    </div>
                                    <div className='d-flex flex-column mt-3'>
                                        Number:
                                        ...
                                        {erors.number && <h6 className='text-black'>{erors.number.message}</h6>}
                                    </div>
                            ...
                            <div className='d-flex flex-column'>
                                ...
                                {erors.mail && <h6 className='text-black'>{erors.mail.message}</h6>}
                            </div>
                            <div className='d-flex flex-column mt-3'>
                                Password:
                                ...
                                {erors.password && <h6 className='text-black'>{erors.password.message}</h6>}
                            </div>
